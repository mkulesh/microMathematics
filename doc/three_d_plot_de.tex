...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{three_d_plot_fig1.png} \end{tabular}\end{center}

Setzen Sie den Funktionsnamen F(x,y) in
das untere Mittelfeld:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{three_d_plot_fig2.png} \end{tabular}\end{center}
...
\end{tabular}\end{center}
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{three_d_plot_fig3.png} \end{tabular}\end{center}
...
\end{tabular}\end{center}
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{three_d_plot_fig4.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{three_d_plot_fig5.png} \end{tabular}\end{center}