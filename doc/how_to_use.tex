...
% Exported from microMathematics, version 1.25
...
in the center, tool bar at the bottom,
action bar at the top, and floating
action button(s) towards bottom right.

The content of the action bar depends
on the screen resolution and device
orientation. The buttons can be shown
in action bar directly, or placed
within ''three-dots'' menu.
...
buttons in the tool bar, or the ''New
...
select the term.  A context menu
appears at the top. The selected term
can be deleted, copied to clipboard,
pasted from clipboard or an other
operator or function can be inserted
using buttons from the tool bar or
keyboard. The button ''Insert in the
left of selected'' from the context
menu switches the insertion mode:
before or after the selected term.
''Expand selection'' button allows to
...
microMathematic'', provides the list of
