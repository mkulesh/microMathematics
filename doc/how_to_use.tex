...
A function is a relation between given
argument and a set of permissible
outputs with the property, that each
argument value is related to exactly
one output. Currently, only functions
of single argument are supported.
...
calculation result is just a number:
\begin{center}\begin{tabular}{c}
