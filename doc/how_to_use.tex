...
% Exported from micro Mathematics Plus, version 2.15
...
an older state:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig1.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig2.png} \end{tabular}\end{center}

or the ''Add equation'' button from the
tool bar:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig3.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig4.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig5.png} \end{tabular}\end{center}
...
The interval elements can be accessed
as follows:
\begin{center}\begin{tabular}{ccc}
  $x \left( 0\right)  = 0.0$ &
  $x \left( 1\right)  = 0.1$ &
...
the second and the first value:
\begin{center}\begin{tabular}{c}
...
or more arguments and a set of
...
the tool bar:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig6.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig7.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig8.png} \end{tabular}\end{center}
...
middle-bottom field:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig9.png} \end{tabular}\end{center}
...
The 3D plot element displays a graph
of a single function that depends on
two arguments. To create such a plot,
use the ''New element'' button in the
action bar or the ''Add 3D plot'' button
from the tool bar:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig10.png} \end{tabular}\end{center}
\begin{center}\begin{tabular}{cc}
  $x := \left[ -10,\, -9.5 \,..\, 10 \right]$ &
  $y := \left[ -10,\, -9.5 \,..\, 10 \right]$ \cr
\end{tabular}\end{center}
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig11.png} \end{tabular}\end{center}
...
is also possible:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig12.png} \end{tabular}\end{center}
...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig13.png} \end{tabular}\end{center}

If the whole text within a fregment is 
...
the tool bar:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{how_to_use_fig14.png} \end{tabular}\end{center}
