...
Rechensoftware im Arbeitsblatt
Format. Das Arbeitsblatt kann frei
editiert, auf einer SD Karte
gespeichert werden, von einer SD Karte
aus geöffnet oder in ein Bild- oder
LaTeX-Format exportiert werden. Es
...
einen Überblick darüber, wie man
diese Objekte erstellen und bearbeiten
kann.
...
Zwischen der Zahl und der Einheit
muss ein Leerzeichen stehen. Die
Einheiten können für reelle und
komplexe Zahlen verwendet werden:
\begin{center}\begin{tabular}{ccc}
  $r := 10 m$ &
  $a := {10 m}^{2}$ &
  $v := 10 km / hr$ \cr
...
links von der Gleichung zu finden.
Das Argument muss nicht zuvor im
...
oder Funktionen enthält. Das
Dokument ''functions\_overview.mmt'', das
im Ordner ''Hilfsmittel der
MicroMathematics Plus'' gespeichert
ist, listet alle verfügbaren
Funktionenen auf.
...
d) man kann auf die Array-Elemente
nur mittels eines Index zugreifen:
\begin{center}\begin{tabular}{cc}
  $M_{5,\, 10}  = -1.39106$ &
  $M_{10,\, 5}  = -1.92467$ \cr
\end{tabular}\end{center}
...
berechnende Formel und der rechte
Term ist das Rechnungsergebnis. Das
Resultat wird angezeigt, wenn Sie den
Button ''Berechnen'' drücken. Hier
können Sie sämtliche zuvor bestimmten
Konstanten und Funktionen verwenden,
sowie alle integrierte Funktionen.

Innerhalb des linken Terms können
Sie sämtliche zuvor bestimmten
Konstanten und Funktionen, sowie alle
...
Feld sein und das Funktionsargument
im mittleren unteren Feld.
...
Datei hinzufügen. Nutzen Sie dafür
den Button ''Neu'' in der Menüleiste
oder den Button ''Bild aus Datei
hinzufügen'' in der Werkzeugleiste:
