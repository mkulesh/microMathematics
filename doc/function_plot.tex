...
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig1.png} \end{tabular}\end{center}
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig2.png} \end{tabular}\end{center}
...
from the tool bar:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig3.png} \end{tabular}\end{center}
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig4.png} \end{tabular}\end{center}

By long click on the middle of plot
area, the context menu and the
floating button ''Object properties''
will appear.
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig5.png} \end{tabular}\end{center}
...
this:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig6.png} \end{tabular}\end{center}
...
area:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig7.png} \end{tabular}\end{center}

For example, we can use dotted lines:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig8.png} \end{tabular}\end{center}
...
plot area:
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig9.png} \end{tabular}\end{center}
\begin{center}\begin{tabular}{c} \includegraphics[resolution=320]{function_plot_fig10.png} \end{tabular}\end{center}
