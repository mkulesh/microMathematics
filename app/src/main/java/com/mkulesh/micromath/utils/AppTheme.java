...
public final class AppTheme
{
    ...
    public static int getTheme(Context context, ThemeType type)
    {
        ...
        if (type == ThemeType.MAIN_THEME)
        {
            ...
            final int resId = mainThemes.getResourceId(themeIndex, R.style.BaseThemeTealDeepOrange);
            mainThemes.recycle();
            return resId;
        }
        else
        {
            ...
            final int resId = settingsThemes.getResourceId(themeIndex, R.style.SettingsThemeTealDeepOrange);
