...
/**
 * AndroidSVG is a library for reading, parsing and rendering SVG documents on
 * Android devices.
 * <p>
 * All interaction with AndroidSVG is via this class.
 * <p>
 * Typically, you will call one of the SVG loading and parsing classes then call
 * the renderer, passing it a canvas to draw upon.
 *
 * <h4>Usage summary</h4>
 *
 * <ul>
 * <li>Use one of the static {@code getFromX()} methods to read and parse the
 * SVG file. They will return an instance of this class.
 ...
 * </pre>
 *
 * For more detailed information on how to use this library, see the
 * documentation at {@code http://code.google.com/p/androidsvg/}
 */
...
public class SVG
{
     ...
     * part of it.
     *
     * @param viewId         the id of a view element in the document that defines which
     ...
     *
     * @param canvas   the canvas to which the document should be rendered.
     * @param viewPort the bounds of the area on the canvas you want the SVG
     ...
     * works.
     *
     * @param preserveAspectRatio the new {@code preserveAspectRatio} setting for the root
     *                            {@code <svg>} element.
     * @throws IllegalArgumentException if there is no current SVG document loaded.
     */
        ...
        public void enumeratePath(PathInterface handler)
        {
            ...
            for (int commandPos = 0; commandPos < commandsLength; commandPos++)
            {
                ...
                default:
                    ...
                    handler.arcTo(coords[coordsPos++], coords[coordsPos++],
                            coords[coordsPos++], largeArcFlag, sweepFlag,
                            coords[coordsPos++], coords[coordsPos++]);
                }
            }
        }
